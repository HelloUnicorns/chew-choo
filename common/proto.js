...
exports.Direction = Object.freeze(pb_root.lookupEnum('chewchoo.Direction').values);
exports.InvincibilityState = Object.freeze(pb_root.lookupEnum('chewchoo.InvincibilityState').values);
